...
# Save results to CSV
data[['cluster', 'adjusted_cluster', 'label']].to_csv("./MiraiBotnet_Kmeans_clustering_Compare.csv", index=False)
...
metrics_df.to_csv("./MiraiBotnet_Kmeans_clustering_Compare_Metrics.csv", index=False)
