...
kmedoids = KMedoids(n_clusters=n_clusters, random_state=42, n_init=10)
...
# Save results
data[['cluster', 'adjusted_cluster', 'label']].to_csv("./netML_Kmedians_clustering_Compare.csv", index=False)
...
metrics_df.to_csv("netML_Kmedians_clustering_Compare_Metrics.csv")
