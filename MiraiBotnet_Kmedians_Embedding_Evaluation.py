...
kmedians = KMedoids(n_clusters=2, random_state=42)
...
# Save results to CSV
data[['cluster', 'adjusted_cluster', 'label']].to_csv("./MiraiBotnet_Kmedians_clustering_Compare.csv", index=False)
...
metrics_df.to_csv("./MiraiBotnet_Kmedians_clustering_Compare_Metrics.csv", index=False)
