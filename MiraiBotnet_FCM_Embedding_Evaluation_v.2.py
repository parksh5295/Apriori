...
# This file was embedded it similarly to k-means ver3.
...
cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(
    X_reduced.T, c=n_clusters, m=2, error=0.005, maxiter=1000, init=None
)
...
# Save results to CSV
data[['cluster', 'adjusted_cluster', 'label']].to_csv("./MiraiBotnet_FCM_clustering_Compare_v.2.csv", index=False)
...
metrics_df.to_csv("./MiraiBotnet_FCM_clustering_Compare_Metrics_v.2.csv", index=False)
